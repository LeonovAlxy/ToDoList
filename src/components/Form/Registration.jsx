    ...
    <>
      <div className="AuthForm">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="FormError">{errors?.username && <p>{errors?.username?.message}</p>}</div>
          ...
          <div className="FormError">{errors?.email && <p>{errors?.email?.message}</p>}</div>
          ...
          <div className="FormError">{errors?.password && <p>{errors?.password?.message}</p>}</div>
          ...
          <div className="FormError">{errors?.gender && <p>{errors?.gender?.message}</p>}</div>
          ...
          <div className="FormError">{errors?.age && <p>{errors?.age?.message}</p>}</div>
